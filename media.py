...
class Movie():
    ...
    Attributes:
        ...
        imdb_rate: An integer that indicates
        the movie rate based on IMDB website.
    ...
    def show_trailer(self):
        """'show_trailer' Opens a web browser and play
        the movie youtube trailer that was set using
        the class instance.
        """
        # Open web browser and runs the targeted url
